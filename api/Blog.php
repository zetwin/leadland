...
class Blog extends Simpla
{
	...
	*/
	public function get_post($id)
	{
		...
		$query = $this->db->placehold("SELECT b.id, b.url, b.name, b.annotation, b.text, b.meta_title,
		                               b.meta_keywords, b.meta_description, b.visible, b.date, b.last_update
	...
	*/	
	...
	{
		$query = $this->db->placehold("UPDATE __blog SET ?%, last_update=NOW() WHERE id in(?@) LIMIT ?", $post, (array)$id, count((array)$id));
		$this->db->query($query);
		return $id;
	}
