...
<div>
	...
	<div class="block layer">
		<h1>Экспорт товаров в xml для Facebook и Google merchant</h1>
		<form method="POST">
			<input type=hidden name="session_id" value="{$smarty.session.id}">
				<div class="block" style="padding-top:10px"></div> 
				<p><a href="/facebook.xml">facebook.xml</a></p></br>
			<input class="button_green" id="xml_export" type="submit" name="xml_export" value="Экспортировать" />	
		</form>
	</div> 
	{/if}
</div>
