...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div id="column_left">
		...
		<div class="block layer">
			...
			<ul>
				...
				<li><label class=property>Страна производитель</label><input name="country" class="simpla_inp" value="{$brand->country|escape}" /></li>
			</ul>
		</div>
	...
	<!-- Описагние бренда -->
	<div class="block layer">
		<h2>Огромное Описание (только на странице бренда)</h2>
		<textarea name="very_big_description" class="editor_large">{$brand->very_big_description|escape}</textarea>
	</div>
	<!-- Описание бренда (The End)-->
	<input class="button_green button_save" type="submit" name="" value="Сохранить" />
	
	<h2>Описание по категориям</h2>
	<ul>
	{foreach $brand_categories as $c}
	<li>{$c->meta_title} {$c->id}
	<textarea>{$c->description}</textarea>
	</li>
	{/foreach}
	</ul>
