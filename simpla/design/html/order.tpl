...
<div id="order_details">
	...
	<ul class="order_details">
		...
		<li>
			<label class=property>Адрес 
			<a href='http://maps.yandex.ru/' id=address_link_yandex target=_blank><img align=absmiddle src='design/images/map.png' alt='Карта в новом окне' title='Поиск на карте Yandex'></a>
			<a href='http://maps.google.com/' id=address_link_google target=_blank><img align=absmiddle src='design/images/map.png' alt='Карта в новом окне' title='Поиск на карте Гугл'></a>
			</label>
			<div class="edit_order_detail" style='display:none;'>
...
$(function() {
  ...
  function change_variant(element)
  {
	...
	$("a#address_link_yandex").attr('href', 'http://maps.yandex.ru/?text='+$('#order_details textarea[name="address"]').val());
	$("a#address_link_google").attr('href', 'http://maps.google.com/?q='+$('#order_details textarea[name="address"]').val());
