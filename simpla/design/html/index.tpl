...
<div id="main">
	...
	{if in_array('articles', $manager->permissions)}
		<li><a href="index.php?module=ArticlesAdmin"><img src="design/images/menu/articles.png"><b>Статьи</b></a></li>
	{elseif in_array('categories', $manager->permissions)}
		<li><a href="index.php?module=CategoriesAdmin2"><img src="design/images/menu/articles.png"><b>Статьи</b></a></li>
	{elseif in_array('brands', $manager->permissions)}
		<li><a href="index.php?module=BrandsAdmin"><img src="design/images/menu/articles.png"><b>Статьи</b></a></li>
	{elseif in_array('features', $manager->permissions)}
		<li><a href="index.php?module=FeaturesAdmin"><img src="design/images/menu/articles.png"><b>Статьи</b></a></li>
	{/if}
	...
	{if in_array('banners', $manager->permissions)}
			<li><a href="index.php?module=BannersAdmin"><img src="design/images/menu/banners.png"><b>Слайдеры</b></a></li>
	{/if}
