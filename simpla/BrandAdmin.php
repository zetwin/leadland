...
class BrandAdmin extends Simpla
{
  ...
  function fetch()
  {
		...
		if($this->request->method('post'))
		{
			...
			$brand->very_big_description = $this->request->post('very_big_description');
			...
			$brand->country = $this->request->post('country');
		...
		else
		{
			...
			$brand = $this->brands->get_brand($brand->id);
			//$brand_categories = $this->brands->get_brand_categories($brand->id);
			//$brand_categories->description = $this->categories->get_category_brands($category->id, $brand->id);
	
			$this->design->assign('category_brand', $category_brand);
			//$brand_categories = 'zet';
			$this->design->assign('brand_categories', $brand_categories);
		}
